...
export const produtos: IProduto[] = [
    ...
    { id: 2, descricao: "IMAC", preco: 1200.50, descricaoPreco: "À vista no PIX", imagem: "/assets/monitor-1.jpg", quantidadeEstoque:10 },
    ...
    { id: 8, descricao: "GTX 1080", preco: 18449.99, descricaoPreco: "À vista no PIX", imagem: "/assets/placa-video.jpg", quantidadeEstoque:10 },
    { id: 9, descricao: "Ryzen 7 3700x", preco: 1000, descricaoPreco: "À vista no PIX", imagem: "/assets/processador.jpg", quantidadeEstoque:10 },
    { id: 10, descricao: "Macbook Pro", preco: 2500, descricaoPreco: "À vista no PIX", imagem: "/assets/laptop-1.jpg", quantidadeEstoque:10 },
